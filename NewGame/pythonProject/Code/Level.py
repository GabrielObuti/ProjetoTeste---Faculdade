...
from Code.Const import WIN_HEIGHT, WIN_WIDTH, COLOR_WHITE, MENU_OPTION, EVENT_ENEMY
    ...
    def run(self, ):
        ...
        while True:
            ...
            for ent in self.entity_list:
                self.window.blit(source=ent.surf, dest=ent.rect) #Aqui desenho minhas entidades
                self.level_text(14,f'FPS:{clock.get_fps(): .0f}', COLOR_WHITE,(10, 10))
                #print(clock.get_fps())  ------ Aparece somente no console ------
                ent.move()
